...
serialPort2 = serial.Serial(    port="COM7", baudrate=38400, bytesize=8, timeout=2, stopbits=serial.STOPBITS_ONE)


mqttBroker = 'mqtt.beia-telemetrie.ro'
port = 1883
topic  = "training/vital5g/DST-2/depth"
topic2 = "training/vital5g/galati_AIS"
topic3 = "training/vital5g/galati_AIS_decoded"
...
while 1:
    ...
    if serialPort.in_waiting > 0:
        ...
        try:
            ...
            client.publish(topic2,  serialString2  )
            decodat_AIS=decode(serialString2)
            print(decodat_AIS)
