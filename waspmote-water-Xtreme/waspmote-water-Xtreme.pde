...
void linie_de_x( int x)
{
  for ( int i = 0 ; i < x ; i++)
  {
    USB.println(F("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"));
  }
}
...
void masurator_apa()
{
  ...
  frame.createFrame(BINARY, node_ID); // frame1
...
RIUK:
  ...
  frame.createFrame(ASCII, node_ID); // frame2 , clone of  first half of frame1 BUT in ASCII , only used for storing data in SD
  frame.setFrameType(INFORMATION_FRAME_WTR_XTR);
  ...
  */
  ...
  frame.createFrame(ASCII, node_ID); // frame3  clone of  second half of frame1 BUT in ASCII , only used for storing data in SD
  frame.setFrameType(INFORMATION_FRAME_WTR_XTR);
